...
# 匹配空格
spaceRegex = re.compile(r'(\[Moozzi2\] Boku no Hero Academia S2 - )(\d\d)( \(BD 1920x1080 x\.264 Flac\))(\.mkv)')
mo4 = spaceRegex.search('[Moozzi2] Boku no Hero Academia S2 - 01 (BD 1920x1080 x.264 Flac).mkv')
print(mo4.group(2))